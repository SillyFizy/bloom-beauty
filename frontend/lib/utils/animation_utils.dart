...
class AnimationUtils {
  ...
  static double safeAnimationValue(double value, {double min = 0.0, double max = 1.0, double fallback = 1.0}) {
    if (!value.isFinite) {
      return fallback;
    }
  ...
  static Offset safeTransformOffset(double animationValue, double multiplierX, double multiplierY) {
