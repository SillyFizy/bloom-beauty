...
class CelebrityPicksProductCard extends StatelessWidget {
                ...
                children: [
                  ...
                  Flexible(
                    ...
                    child: Text(
                      product.name,
                      style: TextStyle(
                        fontSize: _getNameFontSize(isVerySmall, isSmall,
                            isMedium, isLarge, isCompactHeightAdjusted),
                        fontWeight: FontWeight.w600,
                        color: AppConstants.textPrimary,
                        height: 1.2,
                      ),
                      maxLines: isVeryCompactHeight
                          ? 1
                          : (isCompactHeightAdjusted ? 1 : 2),
                  ...
                  if (product.celebrityEndorsement != null &&
                    ...
                    Flexible(
                      flex: 2,
                      child: _buildCelebrityEndorsement(isVerySmall, isSmall,
                          isMedium, isLarge, isCompactHeightAdjusted),
                    ),
                  ...
                  _buildPriceAndRatingSection(currentPrice, hasDiscount,
  ...
  double _getNameFontSize(bool isVerySmall, bool isSmall, bool isMedium,
      bool isLarge, bool isCompactHeight) {
  ...
  Widget _buildCelebrityEndorsement(bool isVerySmall, bool isSmall,
      bool isMedium, bool isLarge, bool isCompactHeight) {
                  ...
                  child: Center(
                    child: Text(
                      endorsement.celebrityName.isNotEmpty
                          ...
                          : 'C',
                      style: TextStyle(
                        fontSize: _getCelebrityInitialFontSize(
                            isVerySmall, isSmall, isMedium, isLarge),
                        fontWeight: FontWeight.bold,
                        color: AppConstants.surfaceColor,
                      ),
            ...
            children: [
              if (!isCompactHeight)
                Text(
                  'Picked by',
                  style: TextStyle(
                    fontSize: _getCelebrityLabelFontSize(
                        isVerySmall, isSmall, isMedium, isLarge),
              ...
              Text(
                ...
                style: TextStyle(
                  fontSize: _getCelebrityNameFontSize(
                      isVerySmall, isSmall, isMedium, isLarge, isCompactHeight),
                  color: AppConstants.accentColor,
                  fontWeight: FontWeight.w600,
                  height: 1.1,
                ),
  ...
  double _getCelebrityInitialFontSize(
      bool isVerySmall, bool isSmall, bool isMedium, bool isLarge) {
  ...
  double _getCelebrityLabelFontSize(
      bool isVerySmall, bool isSmall, bool isMedium, bool isLarge) {
  ...
  double _getCelebrityNameFontSize(bool isVerySmall, bool isSmall,
      bool isMedium, bool isLarge, bool isCompactHeight) {
  ...
  Widget _buildPriceAndRatingSection(double currentPrice, bool hasDiscount,
      bool isVerySmall, bool isSmall, bool isMedium, bool isLarge) {
    return Row(
            ...
            children: [
              ...
              if (hasDiscount && !isVerySmall)
                Text(
                  ...
                  style: TextStyle(
                    fontSize: _getDiscountPriceFontSize(
                        isVerySmall, isSmall, isMedium, isLarge),
                    color: AppConstants.textSecondary,
  ...
  double _getDiscountPriceFontSize(
      bool isVerySmall, bool isSmall, bool isMedium, bool isLarge) {
